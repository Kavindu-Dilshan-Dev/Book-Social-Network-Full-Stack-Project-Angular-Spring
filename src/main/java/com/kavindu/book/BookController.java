...
public class BookController {
    ...
    @PatchMapping("/share/{book-id}")
    public ResponseEntity<Integer> updateShareBookStatus(
    ...
    public ResponseEntity<Integer> updateArchivedBookStatus(
            @PathVariable("book-id") Integer bookId ,
            Authentication connectedUser
    ){
        return ResponseEntity.ok(service.updateArchivedBookStatus(bookId,connectedUser));
    }
